<header class="bg-blue-900 text-white p-4" x-data="{open: false}">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <x-nav-link url="/applications" :active="request()->is('applications')">Applications</x-nav-link>
    ...
    >
        ...
        @auth
            ...
            <x-nav-link url="/applications" :active="request()->is('applications')" :mobile="true">Applications</x-nav-link>
